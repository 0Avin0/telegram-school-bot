...
function checkAccess(userId) {
    ...
    const hasAccess = ALLOWED_USERS.includes(userId);
    console.log('🔍 Результат перевірки:', hasAccess ? 'ДОЗВОЛЕНО' : 'ЗАБОРОНЕНО');
    return hasAccess;
}

// Блокування доступу
function blockAccess() {
    console.log('🚫 Блокування доступу для користувача');
    elements.appContainer.innerHTML = `
        <div class="access-denied">
            <div class="denied-content">
                ...
                <p style="font-size: 12px; color: #999;">Дозволені ID: ${ALLOWED_USERS.join(', ')}</p>
            </div>
        </div>
    `;
}
    ...
    casino: () => {
        ...
        elements.modalContent.innerHTML = `
            ...
            <div class="info-card">
                ...
                <p>3. Поповніть баланс через картку</p>
                <p>4. Грайте з шансом виграшу 20%</p>
            </div>
            ...
            <div class="info-card">
                ...
                <p>• Шанс виграшу: ${APP_DATA.casino.win_chance}%</p>
...
// Ініціалізація додатка з ПЕРЕВІРКОЮ ID
function initApp() {
