...
const rozklad = {
    ...
    "9": {
        ...
        "Вівторок": ["Географія","Хімія","Основи здоров'я","Зарубіжна ліформатура","Правознавство","Фізична культура","Всесвітня історія"],
...
function openInfoModal() {
    const modalContent = `
        ...
        <div class="modal-content">
            ...
            <div class="info-card">
                <h3>🔗 Підтримка</h3>
                <p>З питань роботи додатку звертайтеся до адміністрації школи.</p>
            </div>
        </div>
    `;
...
function openTelegram() {
    // Спроба відкрити через deep link
